        ...
        return <div className={`sh-navMenu ${this.isHome() ? 'sh-navMenu--home' : ''}`}>
            <div className={`sh-navMenu-wrapper`}>
                <div className='navbar-header sh-navMenu-header'>
                    <button type='button' className='sh-navMenu-toogle navbar-toggle' data-toggle='collapse' data-target='.navbar-collapse'>
                ...
                <ul className='nav navbar-nav sh-navMenu-nav hidden-sm-down'>
                    <li>
